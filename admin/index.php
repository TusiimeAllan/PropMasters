...
if (isset($_GET['property_id'])) {
    ...
    $updateQuery = "UPDATE properties SET approved = 1 WHERE id = $propertyId";
    if (mysqli_query($conn, $updateQuery)) {
        $_SESSION['message'] = "Property approved successfully.";
        $_SESSION['color'] = "green";
    } else {
        $_SESSION['message'] = "Error approving property: " . mysqli_error($conn);
        $_SESSION['color'] = "red";
    }
}
...
<!-- The Area where the admin will approve the pending properties -->
...
<body>
    ...
    <h1 style="margin-top: 150px;">Admin Section</h1>
        ...
        <div class="row">
            <div class="col-md-12 d-flex flex-column justify-content-center align-items-center">
                <div class="mt-3">
                    ...
                    $property_query = "SELECT * FROM properties WHERE approved=0";
                    ...
                    if (mysqli_num_rows($property_result) == 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($property_result)) {
                            ...
                            echo '<div class="mt-3">';
                            echo '<a href="index.php?property_id=' . $row['id'] . '" class="btn btn-primary mr-2">Approve</a>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
